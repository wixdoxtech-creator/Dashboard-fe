...
import { MessageCircle, Users, ChevronLeft, MoreVertical } from "lucide-react";
...
const WhatsApp = () => {
  ...
  const {
    ...
    { email, deviceImei, entity: "whatsapp" },
    {
      skip,
  ...
  useEffect(() => {
    ...
    const result = whatsappData?.data ?? [];
    ...
    for (const msg of whatsappMessages) {
      ...
      if (!map.has(name)) {
        map.set(name, {
          ...
          number: msg.number ?? "",
          avatarBg: "bg-green-400", // or compute per name
        });
      }
    }
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="hidden sm:flex items-center gap-2">
            ...
            <Button
              ...
              title="Delete all WhatsApp chats"
          ...
          {/* Mobile: dropdown with both actions (still right-aligned) */}
        ...
        >
          ...
          <div className="flex-1 p-2 md:p-4">
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 h-full">
              ...
              {/* {activeTab === "calls" && <RecentCalls selectedCall={selectedCall} />} */}
            </div>
          </div>
        </div>
      </div>
