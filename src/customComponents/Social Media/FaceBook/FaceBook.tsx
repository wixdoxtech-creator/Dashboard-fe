...
const FaceBook = () => {
  ...
  const [fbData, setFbData] = useState<SocialData[]>([]);
  ...
  const {
    ...
    { email, deviceImei, entity: "facebook_messenger" },
    { skip, refetchOnMountOrArgChange: false, refetchOnFocus: false }
  );

  const loading =
    authLoading || queryLoading || (isFetching && fbData.length === 0);

  useEffect(() => {
    if (skip) return;
    const result = facebookApiData?.data ?? [];
    setFbData(result);
  }, [skip, facebookApiData]);
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="hidden sm:flex items-center gap-2">
            ...
            <Button
              ...
              title="Delete all facebook chats"
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          >
            ...
            <TabsContent value="chats" className="m-0">
              {loading ? (
                ...
                <ChatList data={fbData} onSelectChat={handleSelectChat} />
              )}
            </TabsContent>
        ...
        >
          ...
          {isMobileView && showDetail && (
            <div className="p-2  flex items-center  bg-blue-300">
              <button
